...
def predict_churn(
    ...
    if prediction == 1:
        ...
        prediction_description = "Dari hasil analisis, model kami dengan keyakinan tinggi memprediksi bahwa pelanggan ini kemungkinan besar akan tetap menjadi pelanggan setia. Beberapa faktor yang mendukung prediksi ini termasuk sejarah pembelian yang stabil, tingkat kepuasan yang tinggi, dan keterlibatan yang konsisten dengan produk atau layanan kami. Kita dapat memanfaatkan kesempatan ini untuk memperluas hubungan dengan pelanggan dan mengembangkan strategi peningkatan nilai pelanggan."
